...
class LeaseOperationTest extends TestCase
{
    ...
    public function test_run_slaveIsBusy(): void
    {
        ...
        {
            // Хозяева
            $master1 = new Master(1, 'Биг Боби');
            $master2 = new Master(2, 'Джон Уик');
            $masterRepository = $this->makeFakeMasterRepository($master1, $master2);

            // Раб
            $slave1 = new Slave(1, 'Смазливый Джамал', 27);
        ...
        // Assert
        $expectedErrors = ['Ошибка. Раб #1 "Смазливый Джамал" занят. Занятые часы: "2017-01-01 01", "2017-01-01 02"'];
